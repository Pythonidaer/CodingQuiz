...
// after 'correct' or 'wrong' div show up, hide after two seconds 
function hideResult() {
    setTimeout(function() {
...
// called for when user tries to submit no initials or too many
...
// get scores array from local storage or empty scores array
function getScore() {
...
// convert initials input to string, add to object with final score, push to array
// then set to local storage and clear screen
function setScore() {
